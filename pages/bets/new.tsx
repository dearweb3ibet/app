...
import BetInputWrapper from "components/bet/BetInputWrapper";
      ...
      >
        {({ values, errors, touched, handleChange }) => (
          <Form>
            ...
            {/* Symbol input */}
            <BetInputWrapper title="That" color="#410c92" sx={{ mb: 3 }}>
              <BetInputSelect
                id="symbol"
                name="symbol"
                value={values.symbol}
            ...
            {/* Date */}
            <BetInputWrapper title="On" color="#4B144B" sx={{ mb: 6 }}>
              <BetInputTextField
                id="date"
                name="date"
                type="date"
